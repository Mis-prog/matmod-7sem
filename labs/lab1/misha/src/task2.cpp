...
double Physics::mt = 0.0;
double Physics::r12x = 0.0;
double Physics::r12y = 0.0;

int main() {
    double r12x0 = Constants::R1 + Constants::R12 + Constants::R2, r12y0 = 0.0, r13x0 =
            Constants::R1 + Constants::R12 + 2 * Constants::R2 + Constants::R23 +
            Constants::R3, r13y0 = 0, v3x0 = 0, v3y0 =
            Constants::U3 + Constants::U2; // нач координаты планеты и спутника
    Physics::mt = 4000;
    double angle = 10;
