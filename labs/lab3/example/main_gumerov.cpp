...
int main() {
    ...
    ofstream out_q_verle("../labs/lab3/misha/result/out_verle_q.txt");
    ofstream out_v_verle("../labs/lab3/misha/result/out_verle_v.txt");
    ofstream out_q_simplex("../labs/lab3/misha/result/out_simplex_q.txt");
    ofstream out_v_simplex("../labs/lab3/misha/result/out_simplex_v.txt");
